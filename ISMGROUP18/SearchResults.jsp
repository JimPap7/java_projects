...
<%
	List<Animal> results = (List<Animal>) session.getAttribute("SearchResults");
	session.removeAttribute("SearchResults"); //check the method
%>
	...
	<% if (results.isEmpty()) { %>
		<div class='container'>
			<div class="alert alert-success">
				<h2><b>Δυστυχώς  δεν υπάρχουν  αδέσποτα με αυτά τα κριτήρια.</b></h2>
			</div>
		</div>
	<% } else {
			for (Animal an: results) { %>
				<form action="../servlet/controller.AdoptController" method="POST">
